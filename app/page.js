...
export default function Home() {
  ...
  return (
    <div>
      <section className="bg-[#254f1a] min-h-screen grid grid-cols-1 md:grid-cols-2 p-[10vw]">
        <div className=" flex flex-col justify-center items-start">
          <p className="text-yellow-300 font-bold text-6xl">Everything you are. In one, simple link in bio.</p>
